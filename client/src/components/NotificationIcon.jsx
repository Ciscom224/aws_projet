...
function notificationsLabel(count) {
  ...
  export default function NotificationIcon(props) {
    ...
    return (
      ...
      {props.type == "notif" && <div className="absolute top-20 right-[360px]"><NotificationMenu  isClicked={isClicked} updateCount={updateCount} setFriendsToAdd={setFriendsToAdd} friendsToAdd={friendsToAdd} /> </div>}
      </>
    );
  }