...
const NavBar = ({uid}) => {
    ...
    return(
<>
        <div className="fixed top-0 left-0 right-0  h-20 flex items-center bg-[#181717] bg-opacity-65" >
            <div className=" text-3xl font-bold fixed left-[5%] flex items-center " ><button onClick={handleLogo}><img src="/images/LogoQuizWiz.png" alt="Logo" className="hidden sm:inline-block"/></button></div>
