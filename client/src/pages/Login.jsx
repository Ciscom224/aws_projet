          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="/" onSubmit={handleSubmit(onSubmit)} >
                  ...
                  <div className="flex items-center justify-between">
                      ...
                      <a className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 dark:text-[#83794f]" onClick={(e) => {
      e.preventDefault();
      navigate('/mdp_oublie');
                  ...
                  <p className="text-sm font-light text-gray-500  dark:text-[#423d28]">
                      Créer un compte? <a className="font-medium text-primary-600 hover:underline dark:text-primary-500 dark:text-[#83794f]" onClick={(e) => {
      e.preventDefault();
