...
export default function AuthUser({ openAuth, onClose,setIsLogin }) {
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={closeForm}>
                <Transition.Child
                    as={Fragment}
                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-transparent text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                <div className="bg-transparent px-4 pb-4 pt-5 sm:p-6 sm:pb-4 ">
                                    ...
                                    <div className="mt-2 text-center sm:ml-4 sm:mt-0 sm:text-left ">
                                        <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-amber-500 ">
                                                ...
                                                login ?
                                                    <div>
                                                        ...
                                                        <form className="space-y-6" action="#" method="POST" >
                                                            <div>
                                                                <label htmlFor="email" className="block text-sm font-medium leading-6 text-amber-500">
                                                                    Email
                                                                </label>
                                                                <div className="mt-2">
                                                                    <input
                                                                    ...
                                                                    <SpanAlerte message={errors.email}  className="mt-1"/>
                                                                ) : null}
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center justify-between">
                                                                <label htmlFor="password" className="block text-sm font-medium leading-6 text-amber-500">
                                                                    Mot de Passe
                                                                </label>
                                                            ...
                                                            <div className="mt-2">
                                                                ...
                                                                />
                                                                {errors.password !== "" ? (
                                                                    <SpanAlerte message={errors.password} className="mt-1" />
                                                                ) : null}
                                                            </div>
                                                            <div className="flex items-start">
                                                                <div className="flex items-center h-5">
                                                                    <input id="remember" aria-describedby="remember" type="checkbox"  name = "remember" {...register("remember")} className="w-4 h-4  checked:bg-blue-500" required="" />
                                                                </div>
                                                    ...
                                                    <div>
                                                        <form className="space-y-6" action="#" method="POST">
                                                            <div>
                                                                <label htmlFor="surName" className="block text-sm font-medium leading-6 text-amber-500">
                                                                    Pseudonyme
                                                                </label>
                                                                <div className="mt-2">
                                                                    <input
                                                                    ...
                                                                    />
                                                                    {errors.surName !== "" ? (
                                                                    <SpanAlerte message={errors.surName} className="mt-2" />
                                                                ) : null}
                                                                </div>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <div className="mt-2">
                                                                    ...
                                                                    />
                                                                    {errors.email !== "" ? (
                                                                    <SpanAlerte message={errors.email} className="mt-2" />
                                                                ) : null}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="mt-2">
                                                                    ...
                                                                    />
                                                                    {errors.password !== "" ? (
                                                                    <SpanAlerte message={errors.password} className="mt-2" />
                                                                ) : null}
                                                                </div>
                                                            </div>

                                                            <div>
                                                                <label htmlFor="password-confirmation" className="block text-sm font-medium leading-6 text-amber-500">
                                ...
                                <div className="w-full px-4 py-3 mx-4">
                                    {
                                        login ?
                                            <button
                                                type="button"
                                                className=" mt-3 rounded-lg bg-amber-500 px-6 py-3 text-sm font-semibold text-black shadow-sm  hover:bg-amber-600 sm:mt-0 sm:w-auto" style={{ "width": "100%" }}
