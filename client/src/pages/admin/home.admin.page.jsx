      ...
      <form className="w-full max-w-sm" >
        ...
        <div className="md:flex md:items-center">
          ...
          <div className="md:w-2/3">
            ...
            <span type="button" className="py-2 mx-2 bg-green-200  px-2 rounded-xl">{count}</span>
          </div>
        </div>
      </form>
      <div className="fixed border-2 border-amber-600 left-10 top-20 h-[70%] w-[30%] px-3 rounded-md bg-black text-white font-bold">
        <h1>API URL : <em className="text-amber-500">https://api.openquizzdb.org/?key={keyApi}&categ={category.toLowerCase()}</em> </h1>
        <hr/>
        <p>
