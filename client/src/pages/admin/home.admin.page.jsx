          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                ...
                onClick={()=>setPage(1)}
              >
               <FontAwesomeIcon icon={faQuestionCircle} className="flex-shrink-0 w-5 h-5 text-amber-500 transition duration-75  group-hover:text-gray-700 dark:group-hover:text-white" />
            ...
            <li>
              <a href="#"
                className="flex items-center p-2 text-white rounded-lg  hover:bg-amber-500 group"
              >
                <FontAwesomeIcon icon={faSignOutAlt} className="flex-shrink-0 w-5 h-5 text-amber-500 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" />
